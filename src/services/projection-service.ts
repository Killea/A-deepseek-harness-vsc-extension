...
export class ProjectionService extends EventEmitter {
  ...
  statsOf(sessionId: string): UsageStatsView | null {
    ...
    if (tokenUsage === null && sessionStats === null && contextPressure === null && contextBreakdown === null) {
      return null
    }
    return {
  ...
  tokenUsageOf(sessionId: string): TokenUsageStatsView | null {
    ...
    if (uncachedInputTokens === undefined && outputTokens === undefined && cacheReadTokens === undefined && cacheWriteTokens === undefined) {
      return null
    }
    return {
  ...
  sessionStatsOf(sessionId: string): SessionStatsView | null {
    ...
    if (turns === undefined && steps === undefined && llmMs === undefined && toolMs === undefined
